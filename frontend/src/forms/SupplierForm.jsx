      ...
      <Tabs defaultActiveKey="1">
                ...
                rules={[
                  { 
                    validator: (_, value) => {
                      ...
                      if (!value && !enValue) {
                        return Promise.reject('At least one company name (Chinese or English) is required');
                      }
        ...
        <TabPane tab="Business Information" key="3">
          ...
          <Row gutter={16}>
            <Col span={24}>
              <Form.Item
                name="businessInfo.businessScope"
              ...
              <Space direction="vertical" size="small">
                <div>
                  ...
                  <Tag color={
                    ...
                    current.status === 'pending_approval' ? 'orange' :
                    current.status === 'inactive' ? 'default' :
                    current.status === 'blacklisted' ? 'red' : 'blue'
                  }>
                    {current.status}
                  </Tag>
                </div>
